...
;------------------------------------------------------------
;	main.c:31: _sdcc_external_startup()
;	-----------------------------------------
...
__sdcc_external_startup:
	...
	ar1 = 0x01
	ar0 = 0x00
;	main.c:33: AUXR |= (XRS1 | XRS0); // Configure XRAM (External RAM) for memory extension
	orl	_AUXR,#0x0c
;	main.c:34: return 0;               // Return 0 to indicate successful startup
	mov	dptr,#0x0000
;	main.c:35: }
	ret
;------------------------------------------------------------
...
___str_1:
	...
	.area CONST   (CODE)
___str_2:
	.ascii "Enter the level(0-255) in hex format"
	.db 0x0a
	.db 0x0d
	.db 0x00
	.area CSEG    (CODE)
