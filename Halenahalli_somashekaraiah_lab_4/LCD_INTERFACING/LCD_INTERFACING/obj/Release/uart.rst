      ...
      00259E                        527 00101$:
                                    ...
                                    529 ;	assignBit
      00259E 10 98 02         [24]  530 	jbc	_RI,00114$
      0025A1 80 FB            [24]  531 	sjmp	00101$
      0025A3                        532 00114$:
                                    533 ;	uart.c:44: return SBUF; // Return the received character
      0025A3 AE 99            [24]  534 	mov	r6,_SBUF
      0025A5 7F 00            [12]  535 	mov	r7,#0x00
      0025A7 8E 82            [24]  536 	mov	dpl,r6
      0025A9 8F 83            [24]  537 	mov	dph,r7
                                    538 ;	uart.c:45: }
      0025AB 22               [24]  539 	ret
                                    540 ;------------------------------------------------------------
                                    ...
                                    549 ;	-----------------------------------------
      0025AC                        550 _putstr:
      0025AC AD 82            [24]  551 	mov	r5,dpl
      0025AE AE 83            [24]  552 	mov	r6,dph
      0025B0 AF F0            [24]  553 	mov	r7,b
                                    554 ;	uart.c:55: while (*s)
      0025B2 7B 00            [12]  555 	mov	r3,#0x00
      0025B4 7C 00            [12]  556 	mov	r4,#0x00
      0025B6                        557 00101$:
      0025B6 8D 82            [24]  558 	mov	dpl,r5
      0025B8 8E 83            [24]  559 	mov	dph,r6
      0025BA 8F F0            [24]  560 	mov	b,r7
      0025BC 12 2E DA         [24]  561 	lcall	__gptrget
      0025BF FA               [12]  562 	mov	r2,a
      0025C0 60 2B            [24]  563 	jz	00103$
                                    564 ;	uart.c:57: putchar(*s++); // Output each character of the string
      0025C2 0D               [12]  565 	inc	r5
      0025C3 BD 00 01         [24]  566 	cjne	r5,#0x00,00116$
      0025C6 0E               [12]  567 	inc	r6
      0025C7                        568 00116$:
      0025C7 8A 01            [24]  569 	mov	ar1,r2
      0025C9 7A 00            [12]  570 	mov	r2,#0x00
      0025CB 89 82            [24]  571 	mov	dpl,r1
      0025CD 8A 83            [24]  572 	mov	dph,r2
      0025CF C0 07            [24]  573 	push	ar7
      0025D1 C0 06            [24]  574 	push	ar6
      0025D3 C0 05            [24]  575 	push	ar5
      0025D5 C0 04            [24]  576 	push	ar4
      0025D7 C0 03            [24]  577 	push	ar3
      0025D9 12 25 8E         [24]  578 	lcall	_putchar
      0025DC D0 03            [24]  579 	pop	ar3
      0025DE D0 04            [24]  580 	pop	ar4
      0025E0 D0 05            [24]  581 	pop	ar5
      0025E2 D0 06            [24]  582 	pop	ar6
      0025E4 D0 07            [24]  583 	pop	ar7
                                    584 ;	uart.c:58: i++;
      0025E6 0B               [12]  585 	inc	r3
      0025E7 BB 00 CC         [24]  586 	cjne	r3,#0x00,00101$
      0025EA 0C               [12]  587 	inc	r4
      0025EB 80 C9            [24]  588 	sjmp	00101$
      0025ED                        589 00103$:
                                    590 ;	uart.c:60: return i + 1; // Return the total number of characters sent, including the
      0025ED 8B 82            [24]  591 	mov	dpl,r3
      0025EF 8C 83            [24]  592 	mov	dph,r4
      0025F1 A3               [24]  593 	inc	dptr
                                    594 ;	uart.c:62: }
      0025F2 22               [24]  595 	ret
                                    596 ;------------------------------------------------------------
      ...
      0025F3 12 25 9E         [24]  607 	lcall	_getchar
                                    608 ;	uart.c:71: putchar(ch);           // Output the character, providing an echo effect
      0025F6 E5 82            [12]  609 	mov	a,dpl
      0025F8 FE               [12]  610 	mov	r6,a
      0025F9 FD               [12]  611 	mov	r5,a
      0025FA 33               [12]  612 	rlc	a
      0025FB 95 E0            [12]  613 	subb	a,acc
      0025FD FF               [12]  614 	mov	r7,a
      0025FE 8D 82            [24]  615 	mov	dpl,r5
      002600 8F 83            [24]  616 	mov	dph,r7
      002602 C0 06            [24]  617 	push	ar6
      002604 12 25 8E         [24]  618 	lcall	_putchar
                                    619 ;	uart.c:72: putchar('\r');
      002607 90 00 0D         [24]  620 	mov	dptr,#0x000d
      00260A 12 25 8E         [24]  621 	lcall	_putchar
                                    622 ;	uart.c:73: putchar('\n');
      00260D 90 00 0A         [24]  623 	mov	dptr,#0x000a
      002610 12 25 8E         [24]  624 	lcall	_putchar
      002613 D0 06            [24]  625 	pop	ar6
                                    626 ;	uart.c:74: return ch;             // Return the character read
      002615 8E 82            [24]  627 	mov	dpl,r6
                                    628 ;	uart.c:75: }
      002617 22               [24]  629 	ret
                                    630 	.area CSEG    (CODE)
                                    631 	.area CONST   (CODE)
                                    632 	.area XINIT   (CODE)
