      ...
      00000E                        470 	.ds 1
                                    ...
                                    518 ;------------------------------------------------------------
                                    519 ;	buffer.c:34: __xdata int16_t get_buffer_size(uint32_t min, uint32_t max, uint32_t divisible) {
                                    520 ;	-----------------------------------------
      ...
      003076 F0               [24]  547 	movx	@dptr,a
                                    548 ;	buffer.c:35: __xdata int16_t buffer_size = 0;
      ...
      0030CB F0               [24]  605 	movx	@dptr,a
                                    606 ;	buffer.c:43: if ((char_received == '\n') || (char_received == '\r')) {
      ...
      0030DD                        616 00147$:
      0030DD                        617 00112$:
                                    618 ;	buffer.c:45: if ((buffer_size < min) || (buffer_size > max)) {
      ...
      003128 12 44 01         [24]  662 	lcall	_printf
      ...
      00313F F0               [24]  675 	movx	@dptr,a
                                    676 ;	buffer.c:49: continue; // Input is invalid, continue reading user input
      003140 02 30 B0         [24]  677 	ljmp	00117$
      003143                        678 00105$:
                                    679 ;	buffer.c:50: } else if (buffer_size % divisible) {
      003143 90 16 43         [24]  680 	mov	dptr,#__modulong_PARM_2
      ...
      003168 12 3F 2E         [24]  700 	lcall	__modulong
      ...
      003193 74 87            [12]  725 	mov	a,#___str_1
      ...
      00319F 12 44 01         [24]  731 	lcall	_printf
      ...
      0031B6 F0               [24]  744 	movx	@dptr,a
                                    745 ;	buffer.c:54: continue; // Input is not divisible, continue reading user input
      0031B7 02 30 B0         [24]  746 	ljmp	00117$
                                    747 ;	buffer.c:56: break; // Input is valid, exit the loop
      0031BA                        748 00113$:
                                    749 ;	buffer.c:58: } else if ((char_received >= '0') && (char_received <= '9')) {
      ...
      0031C6 40 0B            [24]  757 	jc	00109$
                                    758 ;	buffer.c:59: char_received = char_received - '0'; // Convert ASCII character to its
      ...
      0031E7 12 44 01         [24]  777 	lcall	_printf
      ...
      0031F8                        785 00114$:
                                    786 ;	buffer.c:66: buffer_size = (buffer_size * 10) + char_received;
      ...
      003200 90 16 54         [24]  793 	mov	dptr,#__mulint_PARM_2
      ...
      003213 12 42 13         [24]  804 	lcall	__mulint
      ...
      003249 12 44 01         [24]  837 	lcall	_printf
      00324C E5 81            [12]  838 	mov	a,sp
      00324E 24 FB            [12]  839 	add	a,#0xfb
      003250 F5 81            [12]  840 	mov	sp,a
                                    841 ;	buffer.c:70: return buffer_size; // Return the validated buffer size
      ...
      003258 22               [24]  845 	ret
                                    ...
                                    848 	.area CONST   (CODE)
      004E49                        849 ___str_0:
      004E49 49 6E 70 75 74 20 76   850 	.ascii "Input value is out of expected range! Try a different value"
             ...
             6C 75 65
      004E84 0D                     851 	.db 0x0d
      004E85 0A                     852 	.db 0x0a
      004E86 00                     853 	.db 0x00
                                    854 	.area CSEG    (CODE)
                                    855 	.area CONST   (CODE)
      004E87                        856 ___str_1:
      004E87 49 6E 70 75 74 20 76   857 	.ascii "Input value is not divisible by %d! Try a different value"
             61 6C 75 65 20 69 73
             ...
             65
      004EC0 0D                     858 	.db 0x0d
      004EC1 0A                     859 	.db 0x0a
      004EC2 00                     860 	.db 0x00
                                    861 	.area CSEG    (CODE)
                                    862 	.area CONST   (CODE)
      004EC3                        863 ___str_2:
      004EC3 49 6E 76 61 6C 69 64   864 	.ascii "Invalid input character"
             20 69 6E 70 75 74 20
             63 68 61 72 61 63 74
             65 72
      004EDA 0D                     865 	.db 0x0d
      004EDB 0A                     866 	.db 0x0a
      004EDC 00                     867 	.db 0x00
                                    868 	.area CSEG    (CODE)
                                    869 	.area CONST   (CODE)
      004EDD                        870 ___str_3:
      004EDD 25 64                  871 	.ascii "%d"
      004EDF 0D                     872 	.db 0x0d
      004EE0 0A                     873 	.db 0x0a
      004EE1 00                     874 	.db 0x00
                                    875 	.area CSEG    (CODE)
                                    876 	.area XINIT   (CODE)
