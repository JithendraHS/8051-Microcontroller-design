      ...
      003343                        527 00101$:
                                    ...
                                    529 ;	assignBit
      003343 10 98 02         [24]  530 	jbc	_RI,00114$
      003346 80 FB            [24]  531 	sjmp	00101$
      003348                        532 00114$:
                                    533 ;	uart.c:44: return SBUF; // Return the received character
      003348 AE 99            [24]  534 	mov	r6,_SBUF
      00334A 7F 00            [12]  535 	mov	r7,#0x00
      00334C 8E 82            [24]  536 	mov	dpl,r6
      00334E 8F 83            [24]  537 	mov	dph,r7
                                    538 ;	uart.c:45: }
      003350 22               [24]  539 	ret
                                    540 ;------------------------------------------------------------
                                    ...
                                    549 ;	-----------------------------------------
      003351                        550 _putstr:
      003351 AD 82            [24]  551 	mov	r5,dpl
      003353 AE 83            [24]  552 	mov	r6,dph
      003355 AF F0            [24]  553 	mov	r7,b
                                    554 ;	uart.c:55: while (*s)
      003357 7B 00            [12]  555 	mov	r3,#0x00
      003359 7C 00            [12]  556 	mov	r4,#0x00
      00335B                        557 00101$:
      00335B 8D 82            [24]  558 	mov	dpl,r5
      00335D 8E 83            [24]  559 	mov	dph,r6
      00335F 8F F0            [24]  560 	mov	b,r7
      003361 12 34 C6         [24]  561 	lcall	__gptrget
      003364 FA               [12]  562 	mov	r2,a
      003365 60 2B            [24]  563 	jz	00103$
                                    564 ;	uart.c:57: putchar(*s++); // Output each character of the string
      003367 0D               [12]  565 	inc	r5
      003368 BD 00 01         [24]  566 	cjne	r5,#0x00,00116$
      00336B 0E               [12]  567 	inc	r6
      00336C                        568 00116$:
      00336C 8A 01            [24]  569 	mov	ar1,r2
      00336E 7A 00            [12]  570 	mov	r2,#0x00
      003370 89 82            [24]  571 	mov	dpl,r1
      003372 8A 83            [24]  572 	mov	dph,r2
      003374 C0 07            [24]  573 	push	ar7
      003376 C0 06            [24]  574 	push	ar6
      003378 C0 05            [24]  575 	push	ar5
      00337A C0 04            [24]  576 	push	ar4
      00337C C0 03            [24]  577 	push	ar3
      00337E 12 33 33         [24]  578 	lcall	_putchar
      003381 D0 03            [24]  579 	pop	ar3
      003383 D0 04            [24]  580 	pop	ar4
      003385 D0 05            [24]  581 	pop	ar5
      003387 D0 06            [24]  582 	pop	ar6
      003389 D0 07            [24]  583 	pop	ar7
                                    584 ;	uart.c:58: i++;
      00338B 0B               [12]  585 	inc	r3
      00338C BB 00 CC         [24]  586 	cjne	r3,#0x00,00101$
      00338F 0C               [12]  587 	inc	r4
      003390 80 C9            [24]  588 	sjmp	00101$
      003392                        589 00103$:
                                    590 ;	uart.c:60: return i + 1; // Return the total number of characters sent, including the
      003392 8B 82            [24]  591 	mov	dpl,r3
      003394 8C 83            [24]  592 	mov	dph,r4
      003396 A3               [24]  593 	inc	dptr
                                    594 ;	uart.c:62: }
      003397 22               [24]  595 	ret
                                    596 ;------------------------------------------------------------
      ...
      003398 12 33 43         [24]  607 	lcall	_getchar
                                    608 ;	uart.c:71: putchar(ch);           // Output the character, providing an echo effect
      00339B E5 82            [12]  609 	mov	a,dpl
      00339D FE               [12]  610 	mov	r6,a
      00339E FD               [12]  611 	mov	r5,a
      00339F 33               [12]  612 	rlc	a
      0033A0 95 E0            [12]  613 	subb	a,acc
      0033A2 FF               [12]  614 	mov	r7,a
      0033A3 8D 82            [24]  615 	mov	dpl,r5
      0033A5 8F 83            [24]  616 	mov	dph,r7
      0033A7 C0 06            [24]  617 	push	ar6
      0033A9 12 33 33         [24]  618 	lcall	_putchar
                                    619 ;	uart.c:72: putchar('\r');
      0033AC 90 00 0D         [24]  620 	mov	dptr,#0x000d
      0033AF 12 33 33         [24]  621 	lcall	_putchar
                                    622 ;	uart.c:73: putchar('\n');
      0033B2 90 00 0A         [24]  623 	mov	dptr,#0x000a
      0033B5 12 33 33         [24]  624 	lcall	_putchar
      0033B8 D0 06            [24]  625 	pop	ar6
                                    626 ;	uart.c:74: return ch;             // Return the character read
      0033BA 8E 82            [24]  627 	mov	dpl,r6
                                    628 ;	uart.c:75: }
      0033BC 22               [24]  629 	ret
                                    630 	.area CSEG    (CODE)
                                    631 	.area CONST   (CODE)
                                    632 	.area XINIT   (CODE)
